            ...
            <div className="container">
                <div className="footer-top">
                    ...
                    <div className="footer-col brand-col">
                        <img src="/assets/logo-isotype.png" alt="Lukstore Isotype" className="footer-iso" style={{ width: '40px', marginBottom: '1rem' }} />
                    ...
                    <div className="footer-col contact-col">
                        ...
                        <ul className="footer-contact-list">
                            ...
                            <li>
                                <span className="icon">📱</span>
                                <a href="tel:+56948100032">+56 9 4810 0032</a>
                            </li>
                            <li>
                                <span className="icon">✉️</span>
                                <a href="mailto:contacto@lukstore.cl">contacto@lukstore.cl</a>
                            </li>
                        </ul>
                        ...
                        <div className="social-links-new">
                            ...
                            <a href="https://wa.me/56948100032" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
