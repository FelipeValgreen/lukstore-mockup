                ...
                <div className="footer-top">
                    ...
                    <div className="footer-col newsletter-col">
                        ...
                        <div className="social-links" style={{ justifyContent: 'flex-start', marginBottom: '1.5rem' }}>
                            ...
                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ border: 'none', width: 'auto', padding: '0' }}>Instagram</a>
                            <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={{ border: 'none', width: 'auto', padding: '0' }}>TikTok</a>
                        </div>
                    </div>
                </div>
